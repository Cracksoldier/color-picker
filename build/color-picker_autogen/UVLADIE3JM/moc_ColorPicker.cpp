...
void ColorPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ColorPicker::*)(QColor )>(_a, &ColorPicker::colorPicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ColorPicker::*)()>(_a, &ColorPicker::pickCanceled, 1))
            return;
    }
}
...
// SIGNAL 0
void ColorPicker::colorPicked(QColor _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ColorPicker::pickCanceled()
{
